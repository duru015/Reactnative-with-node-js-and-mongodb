...
export default function SignUp(){
    const  register = async ({navigation})=>{
        ...
        console.log("username:"+data1.username+" "+"password"+data1.password+" " +data1.confirmPassword);
    ...
    return(
        ...
        <TextInput placeholder="Enter Username" style={styles.username} onChangeText={(e)=>setUsername(e)} />
        <Text style={styles.userdata}>Password</Text>
        <TextInput placeholder="Password" style={styles.username} onChangeText={(e)=>setPassword(e)}  />
        <Text style={styles.userdata}>Confirm Password</Text>
        <TextInput placeholder="Confirm Password" style={styles.username} onChangeText={(e)=>setConfirmPassword(e)}  />
        <TouchableOpacity>
        <LinearGradient colors={['#59afb5','#077af5']} style={styles.LoginUser} >
        <Text style={styles.Button1} onPress={register}  >SignUp</Text>
        </LinearGradient>
        </TouchableOpacity>
        </View>
